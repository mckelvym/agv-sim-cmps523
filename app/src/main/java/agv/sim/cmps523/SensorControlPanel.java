...
public class SensorControlPanel extends JDialog
{
	...
	SensorControlPanel(){
		...
		z_hit_labels.put(new Integer(0), new JLabel("None"));
		z_hit_labels.put(new Integer(50), new JLabel("Less"));
		z_hit_labels.put(new Integer(100), new JLabel("More"));
		z_hit_slider.setLabelTable(z_hit_labels);
		
		Hashtable z_short_labels = new Hashtable();
		z_short_labels.put(new Integer(0), new JLabel("None"));
		z_short_labels.put(new Integer(50), new JLabel("Less"));
		z_short_labels.put(new Integer(100), new JLabel("More"));
		z_short_slider.setLabelTable(z_short_labels);
		
		Hashtable z_max_labels = new Hashtable();
		z_max_labels.put(new Integer(0), new JLabel("None"));
		z_max_labels.put(new Integer(50), new JLabel("Less"));
		z_max_labels.put(new Integer(100), new JLabel("More"));
		z_max_slider.setLabelTable(z_max_labels);
		
		Hashtable z_rand_labels = new Hashtable();
		z_rand_labels.put(new Integer(0), new JLabel("None"));
		z_rand_labels.put(new Integer(50), new JLabel("Less"));
		z_rand_labels.put(new Integer(100), new JLabel("More"));
	...
	private class SensorDisplayHandler implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (disp.equals("Yes"))
				AGVsim.m_testbedview.m_draw_sensor_beams = true;
			else 
				AGVsim.m_testbedview.m_draw_sensor_beams = false;
	...
	private class SensorReturnDisplayHandler implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			String disp = (String)((JComboBox)e.getSource()).getSelectedItem();
			if (disp.equals("Yes"))
				AGVsim.m_testbedview.m_draw_sensor_return_beams = true;
			else 
				AGVsim.m_testbedview.m_draw_sensor_return_beams = false;
			AGVsim.m_testbedview.repaint();						
		}
	}
