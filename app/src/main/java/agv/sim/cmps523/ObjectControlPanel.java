...
public class ObjectControlPanel extends JDialog
{
	...
	private class ObjectAddHandler implements ActionListener {
		public void actionPerformed(ActionEvent e){
			int x = (new Integer(x_loc_field.getText())).intValue();
			int y = (new Integer(y_loc_field.getText())).intValue();
	...
	private class ObjectIdDisplayHandler implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (disp.equals("Yes"))
				AGVsim.m_testbedview.m_draw_object_id = true;
			else 
				AGVsim.m_testbedview.m_draw_object_id = false;
